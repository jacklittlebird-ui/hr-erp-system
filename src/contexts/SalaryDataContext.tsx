...
export const calcGross = (r: Omit<SalaryRecord, 'year' | 'employeeId'>) =>
  r.basicSalary + r.transportAllowance + r.incentives + r.livingAllowance + r.stationAllowance + r.mobileAllowance;

export const calcNet = (r: Omit<SalaryRecord, 'year' | 'employeeId'>) =>
  calcGross(r) - r.employeeInsurance;
...
// Pre-populated mock salary data
const initialSalaryRecords: SalaryRecord[] = [
  {
    year: '2026', employeeId: 'Emp001',
